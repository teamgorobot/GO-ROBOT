...
m1.control.limits(2000, 2000, 100)
m2.control.limits(2000, 2000, 100)
...
def run():
    ...
    straight(-70)
    turnarm(90)
    #bringing away figures 1+2
    straight(130)
    slow()
    turn(right, 180)
    fast()
    turnarm(-90)
    #going to get figures 3+4
    straight(80)
    turn(left, 90)
    straight(65)
    turn(left, 90)
    straight(-55)
    turnarm(90)
    #bringing away figures 3+4
    straight(150)
    slow()
    turn(right, 180)
    fast()
    turnarm(-90)
    #bringing away artefact 1
    straight(150)
    grab()
    straight(-25)
    #getting artefact 2
